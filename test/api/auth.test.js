...
describe("Auth route", () => {
  ...
  describe("SignUp", () => {
    it("Should return status 201 and JWT token if email and username not used", done => {
      chai
        .request(server)
        .post(signup)
  ...
  describe("SignIn", () => {
    it("Should return JWT token and status 200 if username and password correct", done => {
      chai
        .request(server)
        .post(signin)
